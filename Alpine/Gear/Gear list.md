...
## **All equipment pieces and brands which make them:**

1. Outer layer/Shell (WATERPROOF Windbreaker jacket)
   -Arcteryx
   -Mountain equipment
   -Colombia (Pay attention to the Titanium line)
   -Rab
2. Insulation (Puffer jacket + Trousers)
   -Arcteryx 
   -Rab 
   -North Face
   -Colombia
3. Base layer + Midlayer (thermo/synthetic and midlayer fleece)
   -Haglofs
   -Colombia
   -Decathlon
   -As you like depending on what you have
4. Footwear (Alpine boots B2 class)
   -La sportiva
   -Scarpa
   -Mammut
5. Ice axes (2 per person, able to rent)
   -Petzl
   -Simond
6. Crampons (10-12 teeth, compatible to shoes, able to rent)
   -Petzl
   -Simond
   -Random compatible (text me or find yourself)
7. Helmet (Ain't always needed for Breithorn)
   -Petzl
   -Simond
   -Black Diamond
8. Harness + safety devices + rope (Able to rent)
   -Petzl
   -Simond
9. Backpack (40-60L crucial, no more no less)
   -Osprey
   -Mammut
   -Simond
   -Deuter
